...
def evaluate(env, maddpg, logger, record_gif=False, num_eval_episodes=10, end_episode=0, global_step=0, algo=None):
    ...
    for episode in range(num_eval_episodes):
        ...
        while not done:
            ...
            if algo == "MASAC":
                actions_list = maddpg.act(states_list, deterministic=True)  # No noise for eval
            else:
