...
def parse_args():
    ...
    parser.add_argument("--algo", type=str, default="MADDPG", choices=["MADDPG", "MADDPGApprox", "MATD3", "MASAC"],
                       help="Algorithm to use")
    parser.add_argument("--total-timesteps", type=int, default=int(1500000), help="Total timesteps")
    ...
    parser.add_argument("--min-noise", type=float, default=0.01, help="Minimum noise scale")
...
def train(args):
    ...
    if args.algo == "MADDPG":
        ...
        maddpg = MATD3(
            ...
            action_low=action_low,
            action_high=action_high,
            policy_update_freq=args.policy_update_freq # 传入新参数
        )
