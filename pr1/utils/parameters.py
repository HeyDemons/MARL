...
def parameters():
    ...
    parser.add_argument('--learn_interval', type=int, default=2,
    ...
    parser.add_argument('--epsilon_start', type=float, default=1.0, help='start value of epsilon for exploration')
    parser.add_argument('--epsilon_min', type=float, default=0.05, help='end value of epsilon for exploration') 
    parser.add_argument('--random_steps', type=int, default=2e3, help='random steps before the agent start to learn') #  2e3
    ...
    parser.add_argument('--critic_lr', type=float, default=5e-3, help='learning rate of critic') # .002
