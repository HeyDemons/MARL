...
def parameters():
    ...
    parser.add_argument("--episode_num", type = int, default = 30000) # 5000
    ...
    parser.add_argument('--random_steps', type=int, default=2e5, help='random steps before the agent start to learn') #  2e3
