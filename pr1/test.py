...
if __name__ == '__main__':
    ...
    # 加载模型的时间戳
    load_timestamp = "2025-06-20_16-41"
    ...
    if args.algorithm == 'MADDPG':
        ...
        agent = MASAC(dim_info, args.buffer_capacity, args.batch_size, args.actor_lr, args.critic_lr, args.alpha_lr,action_bound, _chkpt_dir = chkpt_dir, _model_timestamp = model_timestamp)    
    elif args.algorithm == 'MATD3':
        print('---- 使用MATD3算法 ----')
        from agent.matd3.matd3_agent import MATD3
        agent = MATD3(dim_info, args.buffer_capacity, args.batch_size, args.actor_lr, args.critic_lr, action_bound, _chkpt_dir = chkpt_dir, _model_timestamp = model_timestamp)
    else:
